	...
	*/
	class Shoestrap_Layout {
		...
		public static function content_width_px( $echo = false ) {
			...
			$container  = 1260; //= filter_var( $ss_settings['screen_large_desktop'], FILTER_SANITIZE_NUMBER_INT );
			$gutter     = 30; //= filter_var( $ss_settings['layout_gutter'], FILTER_SANITIZE_NUMBER_INT );
