...
<div class="bbp-forum-header">
	<div class="bbp-meta well">
		<span class="bbp-forum-post-date"><?php printf( __( 'Last updated %s', 'knowledgepress' ), bbp_get_forum_last_active_time() ); ?></span>
		<a href="<?php bbp_forum_permalink(); ?>" class="bbp-forum-permalink pull-right">#<?php bbp_forum_id(); ?></a>
	</div><!-- .bbp-meta -->
	<div class="bbp-forum-title">
		<?php do_action( 'bbp_theme_before_forum_title' ); ?>
		<h4><?php _e( 'Forum: ', 'knowledgepress' ); ?><a href="<?php bbp_forum_permalink(); ?>"><?php bbp_forum_title(); ?></a></h4>
